function renderMemberDetails(pageDate, independentPage, footerFunc) {
	...
	for (let i = 0; i < keys.length; i++) {
		...
		let page = `<div class="w-[2339px] h-[1653px] relative ${i === 0 ? 'pt-[89px]' : 'pt-[83px]'}">
			${
				i === 0
					? '<div class="pb-[29px] text-[28px] leading-[28px] pl-[53px]">Member Details :-</div>'
					: ''
			}
			<div class="w-[2284px] pl-[53px]">
        ...
        <div class="w-[444px] flex flex-col">
          <div class="h-[55px] border border-black border-l-0 border-b-0 flex justify-center items-center">Wages</div>
          <div class="h-[85px] flex">
            <div
              class="h-full w-[111px] border border-black border-l-0 flex justify-center items-center pl-[10px]"
            >
              Gross
            </div>
            <div
            ...
            <div class="h-full w-[111px] border border-black border-l-0 flex justify-center items-center pl-[10px]">EDLI</div>
          </div>
        </div>
        <div class="w-[514px] flex flex-col">
          <div class="h-[55px] border border-black border-l-0 border-b-0 flex justify-center items-center pl-[10px]">
            Contribution Remitted
          </div>
          <div class="h-[85px] flex">
            <div
              class="h-full w-[139px] border border-black border-l-0 flex justify-center items-center pl-[10px]"
            >
              EE
            </div>
            <div
            ...
            <div class="h-full w-[97px] border border-black border-l-0 text-center flex items-center pl-[10px]">NCP Days</div>
          </div>
        </div>
        <div
        ...
        <div class="w-[430px] flex flex-col">
          <div class="h-[55px]  border border-black border-l-0 border-b-0  flex justify-center items-center pl-[10px]">
            PMRPY / ABRY Benefit
          </div>
          <div class="h-[85px] flex">
            <div
              class="h-full w-[139px]  border border-black border-l-0 text-center flex items-center pl-[10px]"
            >
              Pension Share
            </div>
            <div
              class="h-full w-[139px] border border-black border-l-0 flex text-center items-center px-4 pl-[10px]"
            >
              ER PF Share
            </div>
            <div class="h-full w-[152px]  border border-black border-l-0 flex justify-center items-center pl-[10px]">
              EE Share
            </div>
          </div>
        </div>
        <div class="w-[145px] border border-black border-l-0 text-center flex pt-[15px] pl-[10px]">
          Posting Location of the member
			...
			<div class="table-content relative" style="z-index: 1">`
		...
		const temp = res.map(item => {
			return `<div class="flex flex-nowrap text-[20px] " style="height: ${+item.rowHigh + 1}px">
				...
				<div
					class="h-full w-[152px] border border-black flex items-center justify-end px-[12px]  border-l-0 border-t-0"
				>
					${item.EEShare ? item.EEShare : '-'}
				</div>
				<div
					class="h-full w-[145px] border border-black flex items-center justify-end px-[12px] border-l-0 border-t-0"
				>
