        ...
        <div class="mr-[21px] flex flex-col">
          ...
          <div class="flex h-[444px] flex-col text-[28px]">
            <div class="flex flex-1 font-bold">
              ...
              <div
                class="w-[723px] border font-bold border-black -ml-px flex justify-center items-center"
              >
                Reason Name
              </div>
            </div>
            <div class="flex flex-1 -mt-px">
              ...
              <div class="w-[723px] border pl-[12px] border-black -ml-px flex items-center">
        ...
        <div class="flex flex-col">
          ...
          <div class="flex h-[444px] flex-col text-[28px]">
            <div class="flex flex-1 font-bold">
              ...
              <div
                class="w-[932px] border font-bold border-black -ml-px flex justify-center items-center"
              >
                Reason Name
              </div>
            </div>
            <div class="flex flex-1 -mt-px">
              ...
              <div class="w-[932px] border pl-[12px] border-black -ml-px flex items-center">
